...
import catalog from './catalog_competitor.json';
  ...
  return (
    <div className="min-h-screen bg-[#070b14] text-slate-100 flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-40 bg-[#0a101d]/95 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-9 h-9 rounded-xl bg-cyan-600 flex items-center justify-center font-black text-white text-base shadow-lg shadow-cyan-600/30">
              🌧️
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-lg font-black tracking-tight text-white">Monsoon Trekker</span>
                <span className="text-[10px] font-mono font-bold bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 px-2 py-0.5 rounded-full">
                  Sample Merchant Store
                </span>
              </div>
              <span className="text-[11px] text-slate-400 font-mono hidden sm:inline">High-Performance Weather Gear Outfitters</span>
            </div>
          </div>

          <div className="flex items-center space-x-3">
            <div className="hidden sm:flex items-center space-x-1.5 px-3 py-1 rounded-full bg-cyan-950/60 border border-cyan-500/30 text-cyan-300 text-xs font-mono">
              <Award className="w-3.5 h-3.5" />
              <span>AI Search Benchmark Store</span>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center space-x-1.5 px-3.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-md shadow-indigo-600/20 transition-all"
            >
              <span>Analyze in Catalyst</span>
      ...
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1">
        ...
        {/* Banner */}
        <div className="p-4 rounded-2xl border border-cyan-500/30 bg-cyan-950/20 text-cyan-300 mb-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center space-x-2 text-xs">
            <Info className="w-4 h-4 flex-shrink-0" />
            <span>
              <strong>Rich Machine-Readable Store:</strong> Monsoon Trekker exposes 11 verified attributes, full Schema.org JSON-LD tags, and rich FAQs. AI shopping assistants index this store with 55% win rate.
            </span>
          </div>
          ...
          >
            Diagnose Competitor Edge in Catalyst →
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 flex items-center justify-center min-h-[380px] relative overflow-hidden group">
              ...
              <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-cyan-500/20 border border-cyan-500/40 text-cyan-300 text-xs font-bold flex items-center gap-1">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-3 text-xs">
                ...
                <span className="text-slate-400 font-mono">{selectedProduct.review_count || 312} Verified Buyer Reviews</span>
              </div>
            </div>
            ...
            <div className="flex items-baseline space-x-3 pb-4 border-b border-slate-800">
              ...
              <span className="text-xs text-cyan-400 font-mono font-semibold">In Stock • Fast Monsoon Dispatch</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-1 flex items-center justify-between text-xs font-mono text-slate-400">
                <span className="flex items-center gap-1.5">
                  ...
                  <span>Schema.org JSON-LD: <strong>✓ Valid (Product + Offers + AggregateRating)</strong></span>
                </span>
              ...
              {viewJsonLd && (
                <div className="bg-[#03060a] p-4 rounded-xl border border-slate-800 font-mono text-[11px] text-cyan-300 overflow-x-auto max-h-48">
                  <pre>
                    {JSON.stringify({
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-cyan-600 hover:bg-cyan-700 active:scale-[0.99] text-white text-base font-bold shadow-xl shadow-cyan-600/20 transition-all flex items-center justify-center space-x-2"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-6 sm:p-8 space-y-6 shadow-2xl relative">
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              ...
              <span className="text-xs font-mono text-slate-400">Monsoon Trekker</span>
            </div>
      ...
      <footer className="border-t border-slate-800 py-6 bg-[#040810] text-center text-xs text-slate-500 font-mono">
        Monsoon Trekker Gear • Connected to Catalyst AI Revenue Agent • Razorpay Buildathon
      </footer>
